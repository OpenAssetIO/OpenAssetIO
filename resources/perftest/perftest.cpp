...
struct BlobTrait : trait::TraitBase<BlobTrait> {
  ...
  void setUrl(Str url) { data()->setTraitProperty(kId, kUrl, std::move(url)); }
};

///////////////////////////////////////////////////////////
class OldManagerInterface {
 public:
  explicit OldManagerInterface(const std::unordered_map<std::string, std::string>& refToPrimStrs)
      : refToPrimStrs_{refToPrimStrs} {}
...
///////////////////////////////////////////////////////////
auto benchmarkOldManager(const std::unordered_map<std::string, std::string>& refToPrimStrs,
...
class NewManagerInterface {
 public:
  explicit NewManagerInterface(const std::unordered_map<std::string, std::string>& refToPrimStrs)
      : refToPrimStrs_{refToPrimStrs} {}
  std::shared_ptr<TraitsData> resolve(const std::string& ref,
...
std::shared_ptr<TraitsData> NewManagerInterface::resolve(const std::string& ref,
                                                         const TraitsData::TraitSet& traitSet) {
...
///////////////////////////////////////////////////////////
auto benchmarkNewManager(const std::unordered_map<std::string, std::string>& refToPrimStrs,
                         const std::vector<std::string>& refs) {
