...
#
"""
A codegen generator that outputs a python package based on the
openassetio_codegen PackageDefinition model.
"""
...
def _create_jinja_env(env_globals, logger):
    ...
    Creates a custom Jinja2 environment with:
     - A package a loader that automatically finds templates within a
       'templates' directory in the openassetio_codegen python package.
     - Updated globals.
     - Custom filters.
    """
    env = jinja2.Environment(loader=jinja2.PackageLoader("openassetio_codegen"))
