...
`openassetio_codegen` module. See `openassetio-codegen --help` for
...
def _create_argparser():
    """
    Returns an argparse parser configured with the openassetio-codegen
    flags and options.
    """
...
def _createStderrLogger():
    ...
    logger = logging.getLogger("openassetio-codegen")
...
def main():
    ...
    # to aid managing codegen files in subsequent build steps.
