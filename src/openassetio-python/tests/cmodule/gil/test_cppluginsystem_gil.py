...
"""
    ...
    def test_instantiate(
        ...
        plugin = a_cpp_plugin_impl_factory.instantiate(the_cpp_gil_check_plugin_identifier)

        assert plugin.identifier() == the_cpp_gil_check_plugin_identifier
...
def a_cpp_plugin_impl_factory(the_cpp_gil_check_plugin_path, a_threaded_logger_interface):
    return CppPluginSystemManagerImplementationFactory(the_cpp_gil_check_plugin_path, a_threaded_logger_interface)
