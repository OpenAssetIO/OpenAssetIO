...
from openassetio.pluginSystem import PythonPluginSystemManagerPlugin, PythonPluginSystemPlugin


class Test_PythonPluginSystemManagerPlugin:
    def test_is_a_PythonPluginSystemPlugin(self):
        assert issubclass(PythonPluginSystemManagerPlugin, PythonPluginSystemPlugin)


class Test_PythonPluginSystemManagerPlugin_identifier:
    def test_raises_NotImplementedException(self):
        with pytest.raises(NotImplementedException):
            PythonPluginSystemManagerPlugin.identifier()


class Test_PythonPluginSystemManagerPlugin_interface:
    def test_raises_NotImplementedException(self):
        with pytest.raises(NotImplementedException):
